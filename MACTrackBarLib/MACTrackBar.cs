    ...
    private Size FitSize
    {
        get
        {
            ...
            if (_orientation == Orientation.Horizontal)
            {
                ...
                if (_textTickStyle is TickStyle.TopLeft or TickStyle.Both)
                {
                    currentUsedPos += textAreaSize;
                }

                if (_tickStyle is TickStyle.TopLeft or TickStyle.Both)
                {
                ...
                if (_textTickStyle is TickStyle.BottomRight or TickStyle.Both)
                {
                    currentUsedPos += textAreaSize;
                }
